...
===============================================
|icon| Account Payment Order Duedate 12.0.1.2.1
===============================================


**Account Payment Order extension**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_payment_order_duedate/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **account_payment_order_duedate** > Install
