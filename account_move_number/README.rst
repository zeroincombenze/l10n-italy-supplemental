...
======================================
|icon| Move Sequence Number 12.0.1.0.1
======================================


**Add methods to get move number as integer extending ir_sequence and account_move**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_move_number/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **account_move_number** > Install
