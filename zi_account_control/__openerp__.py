...
Every chart of account code ending with '0'
is reserved to Zeroincombenze® schema.
...
fornisce un piano dei conti standard
che copre tutte le esigenze fiscali italiane.
