...
=======================================
|icon| Invoice print details 12.0.1.0.0
=======================================


**Added ddt and sale order references**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_invoice_print_ddt_orders/static/description/icon.png
...
|en| Set the references to delivery notes and sales orders in the customer invoice print.

|

|it| Imposta nella stampa fattura clienti i riferimenti ai DDT e agli Ordini di Vendita.
...
* |menu| Setting > Apps |right_do| Select **account_invoice_print_ddt_orders** > Install
