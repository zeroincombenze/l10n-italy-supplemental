...
=======================================
|icon| Account accrual dates 12.0.1.0.0
=======================================


**Adds start/end accrual dates on invoice lines and move lines**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_accrual_dates/static/description/icon.png
...
|en| This module adds start/end accrual dates on invoice lines and move lines


|

|it| This module adds start/end accrual dates on invoice lines and move lines
...
* |menu| Setting > Apps |right_do| Select **account_accrual_dates** > Install
