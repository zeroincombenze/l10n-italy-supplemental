...
======================
|icon| l10n_eu_account
======================


**EU invoicing & accounting base**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/10.0/l10n_eu_account/static/description/icon.png
...
|en| EU invoice & account base structure
-----------------------------------
...
|it| Struttura per contabilità conforme EU
-------------------------------------
...
* |menu| Setting > Apps |right_do| Select **l10n_eu_account** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **l10n_eu_account** > Update
