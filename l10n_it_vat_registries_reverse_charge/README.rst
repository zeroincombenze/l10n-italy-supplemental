...
===================================================
|icon| ITA - Registri IVA Reverse Charge 12.0.1.0.0
===================================================


.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/l10n_it_vat_registries_reverse_charge/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **l10n_it_vat_registries_reverse_charge** > Install
...
12.0.1.0.0 (2022-04-27)
~~~~~~~~~~~~~~~~~~~~~~~

* [IMP] Funzionalità che aggiorna il numero fattura con l'origine in caso di fatture RC o autofatture
