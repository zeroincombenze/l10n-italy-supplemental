...
==============================================
|icon| Recovery last invoice number 10.0.0.1.0
==============================================


**Decrement invoice sequence if unlink last invoice**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/10.0/account_invoice_last_number/static/description/icon.png
...
|en| This module recover last invoice sequence if user is unlinking the last invoice number.


|

|it| Recupero ultimo numero di fattura
...
* |menu| Setting > Apps |right_do| Select **account_invoice_last_number** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **account_invoice_last_number** > Update
...
Last Update / Ultimo aggiornamento: 2020-08-03
