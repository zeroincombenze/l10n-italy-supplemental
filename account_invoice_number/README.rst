...
=========================================
|icon| Invoice Sequence Number 12.0.1.0.1
=========================================


**Add methods to get invoice number as integer extending ir_sequence and account_invoice**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_invoice_number/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **account_invoice_number** > Install
