...
=====================================================
|icon| Account SEPA Credit Tranfer ITA CBI 12.0.1.0.0
=====================================================


**Gestione SCT/Bonifico**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_banking_sepa_credit_trasfer_ita/static/description/icon.png
...
|en| Create file CBI for SEPA Credit Transfer


|

|it| Creazione di file CBI per flussi SEPA Credit Transfer
...
* |menu| Setting > Apps |right_do| Select **account_banking_sepa_credit_trasfer_ita** > Install
...
Last Update / Ultimo aggiornamento: 2022-04-14
