...
class wizard_crea_comunicazione(osv.osv_memory):
    ...
    def default_get(self, cr, uid, fields, context=None):
        ...
        res = super(wizard_crea_comunicazione, self).default_get(
        ...
        res['quadro_FA'] = True
        res['quadro_SA'] = True
        # La comunizazione annuale esclude il quadro BL
        res['quadro_BL'] = False
        # La comunicazione annuale esclude il quadro SE
        res['quadro_SE'] = False
    ...
    _columns = {
        ...
        'trimestre':
            fields.integer('Trimestre', size=1),
        ...
        'formato_dati':
            fields.selection((('aggregati', 'Aggregati'),
                              ('analitici', 'Analitici')),
                             'Formato comunicazione', required=True),
        'tipo_fornitore':
            fields.selection((('01', 'Soggetti che inviano'
                                     ' la propria comunicazione'),
                              ('10', 'Intermediari')),
                             'Tipo fornitore', required=True),
        'partner_intermediario':
            fields.many2one('res.partner', 'Intermediario'),
        'quadro_FA':
            fields.boolean('Quadro FA',
                           help="Operazioni documentate da fattura "
                                "esposte in forma aggregata"),
        'quadro_SA':
            fields.boolean('Quadro SA',
                           help="Operazioni senza fattura "
                                "esposte in forma aggregata"),
        'quadro_BL':
            fields.boolean('Quadro BL',
                           help="- Operazioni con paesi con "
                                "fiscalità privilegiata - "
                                "Operazioni con soggetti non residenti "
                                "- Acquisti di servizi da soggetti "
                                "non residenti "),
        'quadro_FE':
            fields.boolean('Quadro FE',
                           help="Fatture emesse e Documenti riepilogativi "
                                "(Operazioni attive)"),
        'quadro_FR':
            fields.boolean('Quadro FR',
                           help="Fatture ricevute e Documenti riepilogativi "
                                "(Operazioni passive)"),
        'quadro_NE':
            fields.boolean('Quadro NE',
                           help="Note di variazione emesse"),
        'quadro_NR':
            fields.boolean('Quadro NR',
                           help="Note di variazioni ricevute"),
        'quadro_DF':
            fields.boolean('Quadro DF',
                           help="Operazioni senza fattura"),
        'quadro_FN':
            fields.boolean('Quadro FN',
                           help="Operazioni con soggetti non residenti "
                                "(Operazioni attive)"),
        'quadro_SE':
            fields.boolean('Quadro SE',
                           help="Acquisti di servizi da non residenti e "
                                "Acquisti da operatori di San Marino"),
        'quadro_TU':
            fields.boolean('Quadro TU',
                           help="Operazioni legate al turismo - "
                                "Art. 3 comma 1 D.L. 16/2012"),
    }
    ...
    def genera_comunicazione(self, cr, uid, ids, context=None):
        ...
        params = {
            ...
            'tipo': wizard['tipo'],
            'comunicazione_da_sostituire_annullare':
                wizard['comunicazione_da_sostituire_annullare'],
            'documento_da_sostituire_annullare':
                wizard['documento_da_sostituire_annullare'],
