...
class wizard_spesometro_export(orm.TransientModel):
    ...
    def _record_B(self, cr, uid, comunicazione, context=None):
        ...
        if comunicazione.soggetto_forma_giuridica == 'persona_fisica':
            if not comunicazione.soggetto_pf_cognome or not comunicazione.soggetto_pf_nome or not comunicazione.soggetto_pf_sesso or \
                    not comunicazione.soggetto_pf_data_nascita or not comunicazione.soggetto_pf_comune_nascita or not comunicazione.soggetto_pf_provincia_nascita:
        ...
        if comunicazione.soggetto_cm_forma_giuridica == 'persona_fisica':
            if not comunicazione.soggetto_cm_pf_cognome or not comunicazione.soggetto_cm_pf_nome or not comunicazione.soggetto_cm_pf_sesso or \
                    not comunicazione.soggetto_cm_pf_data_nascita or not comunicazione.soggetto_cm_pf_comune_nascita or not comunicazione.soggetto_cm_pf_provincia_nascita:
    ...
    def _record_C_BL(self, cr, uid, line, prog_modulo, prog_sezione, context=None):
        ...
        # .. persona fisica
        if line.pf_cognome:
            if not line.pf_nome or not line.pf_data_nascita or not line.pf_comune_stato_nascita or not line.pf_provincia_nascita or \
