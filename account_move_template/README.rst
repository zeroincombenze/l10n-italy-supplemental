...
=======================================
|icon| Account Move Template 12.0.1.0.1
=======================================


**Templates for recurring Journal Entries**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_move_template/static/description/icon.png
...
|en| This module adds account move template wizard to create an account move according to the model choosen


|

|it| Questo modulo aggiunge dei modelli di registrazione contabile per facilitare l'inserimento delle stesse
...
* |menu| Setting > Apps |right_do| Select **account_move_template** > Install
...
12.0.1.0.1 (2020-10-12)
~~~~~~~~~~~~~~~~~~~~~~~

* [IMP] Nascosto tasto aggiungi riga
