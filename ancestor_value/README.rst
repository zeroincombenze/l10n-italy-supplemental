==================================================
|icon| Ancestor Value/Valore ascendente 14.0.1.0.0
==================================================

**Get the ancestor value from current record by a field value**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/14.0/ancestor_value/static/description/icon.png
...
.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/14.0/ancestor_value/static/description/description.gif
...
::
    ...
    deploy_odoo clone -r l10n-italy-supplemental -b 14.0 -G zero -p $HOME/14.0
...
::
    ...
    deploy_odoo update -r l10n-italy-supplemental -b 14.0 -G zero -p $HOME/14.0
    vem amend $HOME/14.0/venv_odoo
