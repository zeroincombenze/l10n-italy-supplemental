==================================================
|icon| Ancestor Value/Valore ascendente 17.0.1.0.0
==================================================

**Get the ancestor value from current record by a field value**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/17.0/ancestor_value/static/description/icon.png
...
.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/17.0/ancestor_value/static/description/description.gif
...
::
    ...
    deploy_odoo clone -r l10n-italy-supplemental -b 17.0 -G zero -p $HOME/17.0
    # Upgrade virtual environment
    vem amend $HOME/17.0/venv_odoo
...
::
    ...
    deploy_odoo update -r l10n-italy-supplemental -b 17.0 -G zero -p $HOME/17.0
    vem amend $HOME/17.0/venv_odoo
...
.. |license opl| image:: https://img.shields.io/badge/licence-OPL-7379c3.svg
    ...
    :alt: License: OPL
.. |Try Me| image:: https://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-try-it-17.svg
    :target: https://erp17.zeroincombenze.it
    :alt: Try Me
