...
========================================
|icon| Assets Management Plus 12.0.1.0.9
========================================


.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/accounting/12.0/assets_management_plus/static/description/icon.png
...
|en| Improvements for asset management
--------------------------------------
...
|it| Campi aggiuntivi per modulo cespiti
----------------------------------------
...
* |menu| Setting > Apps |right_do| Select **assets_management_plus** > Install
