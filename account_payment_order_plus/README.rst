...
============================================
|icon| Account Payment Order Plus 12.0.1.0.0
============================================


**Account Payment Order extension**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_payment_order_plus/static/description/icon.png
...
|en| Payment order extension


|

|it| Estensione del modulo OCA Payment order
...
* |menu| Setting > Apps |right_do| Select **account_payment_order_plus** > Install
...
12.0.1.0.0 (2021-07-15)
~~~~~~~~~~~~~~~~~~~~~~~

* [IMP] Impostati campi importo anticipato e stato anticipo
