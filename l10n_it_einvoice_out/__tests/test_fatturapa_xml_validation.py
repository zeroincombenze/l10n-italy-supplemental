...
class TestFatturaPAXMLValidation(AccountTestUsers):
    ...
    def getAttacment(self, name):
        path = get_module_resource(
            "l10n_it_einvoice_out", "tests", "data", "attah_base.pdf"
        )
    ...
    def getFile(self, filename):
        path = get_module_resource("l10n_it_einvoice_out", "tests", "data", filename)
    ...
    def set_sequences(self, file_number, invoice_number, dt):
        ...
        seq_id = self.data_model.xmlid_to_res_id("l10n_it_einvoice_base.seq_fatturapa")
