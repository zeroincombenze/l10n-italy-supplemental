=================================================================
|icon| Purchase Force Invoiced/purchase_force_invoiced 10.0.1.0.0
=================================================================

**Allows to force the billing status of the purchase order to "Invoiced"**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/10.0/purchase_force_invoiced/static/description/icon.png
...
|en| This module adds the possibility for users to force the invoice status of the
...
.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/10.0/purchase_force_invoiced/static/description/
...
* `Jordi Ballester <jordi.ballester@eficent.com>`__
* Maintainers <False>
* ~~~~~~~~~~~ <False>
...
* `This module is part of the OCA/purchase-workflow <https://github.com/OCA/purchase-workflow/tree/12.0/purchase_force_invoiced>`__
...
Last Update / Ultimo aggiornamento: 2024-07-26
