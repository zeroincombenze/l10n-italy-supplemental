...
==================================
|icon| Import inventory 12.0.0.1.2
==================================


.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/12.0/import_inventory/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **import_inventory** > Install
