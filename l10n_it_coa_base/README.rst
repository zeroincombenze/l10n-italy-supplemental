...
================================================
|icon| Chart of Account improvements 12.0.0.1.25
================================================


.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/l10n_it_coa_base/static/description/icon.png
...
|en| This module makes available tha nature in the Chart of Account and in Account Types and some others fields to print the Italian fiscal balance.
Nature should be:
...
|it| Questo modulo aggiunge la natura del conto e del tipo di conto ed alcuni campi per gestire il bilancio fiscale italiano.
...
* |menu| Setting > Apps |right_do| Select **l10n_it_coa_base** > Install
