...
=========================================================
|icon| Driven invoice from multiple sale order 10.0.0.1.0
=========================================================


**Operator can full invoice multiple sale orders.**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/10.0/sale_plus/static/description/icon.png
...
|en| When multiple sale orders are selected,
operator is asked for invoice method.


|

|it| Anche quando sono selezionati più ordini,
l'operatore può impostare il metodo di fatturazione.
...
* |menu| Setting > Apps |right_do| Select **sale_plus** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **sale_plus** > Update
