...
==========================================
|icon| ITA - Contabilità base 12.0.1.4.5_2
==========================================


**Modulo base usato come dipendenza di altri moduli contabili**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/l10n-italy/12.0/l10n_it_account/static/description/icon.png
...
|it| Modulo di supporto per la contabilità.
...
* `powERP <https://www.librerp.it>`__
