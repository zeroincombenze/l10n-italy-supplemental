...
============================================
|icon| Account invoice tax unique 12.0.1.0.7
============================================


**Account Invoice Tax Unique**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_tax_unique/static/description/icon.png
...
|en| Account invoice line extension
...
* |menu| Setting > Apps |right_do| Select **account_tax_unique** > Install
