...
====================================================
|icon| Account journal Bank IBAN position 12.0.1.0.0
====================================================


**Update view in account journal form**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_journal_bank_iban/static/description/icon.png
...
|en| IBAN moved in bank journal 

|

|it| Spostato campo IBAN nel registro banca
...
* |menu| Setting > Apps |right_do| Select **account_journal_bank_iban** > Install
...
12.0.1.0.0 (2021-12-27)
~~~~~~~~~~~~~~~~~~~~~~~

* [REF] Spostato campo IBAN nel form del registro
