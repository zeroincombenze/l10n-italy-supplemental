...
===================================
|icon| Sequence Recovery 10.0.0.0.1
===================================


.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy-supplemental/10.0/sequence_recovery_last/static/description/icon.png
...
|en| Module to recovery sequences when delete/unklink record.

|

|it| Recupero sequenze.

Modulo per recupreare l'ultimo numero di una sequenza, ad esempio in eliminazione fattura o DdT.
...
* |menu| Setting > Apps |right_do| Select **sequence_recovery_last** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **sequence_recovery_last** > Update
