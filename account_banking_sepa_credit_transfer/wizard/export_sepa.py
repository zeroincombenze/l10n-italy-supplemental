...
class banking_export_sepa_wizard(orm.TransientModel):
    ...
    def create_sepa(self, cr, uid, ids, context=None):
        ...
        # pain_name MUST BE in form 'pain_or_else(variant)'
        # resultant xsd file will be pain_flavor-variant.xsd
        # against standard name pain_flavor.xsd
        # if variant file does not exist, standard file is used
        xsd_file, variant = _get_name_n_params(pain_name)
        if variant:
        ...
        # [antoniov: 2015-07-01] Added variant & country_code
        gen_args = {
        ...
        if variant == 'CBI-IT':
            ...
            xml_root = etree.Element('CBIPaymentRequest', nsmap=pain_ns)
            pain_root = xml_root
        else:
            pain_ns = {
                'xsi': 'http://www.w3.org/2001/XMLSchema-instance',
        ...
        for (requested_date, priority), lines in lines_per_group.items():
            ...
            # [ antoniov: 2015-11-17] add bic of payment order in ctx
            # context['bank_bic'] = \
            #    'sepa_export.payment_order_ids[0].mode.bank_bic'
            ...
            for line in lines:
                ...
                self.generate_party_block(
                    ...
                    partner=line.partner_id, context=context)
