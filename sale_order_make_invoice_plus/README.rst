...
==============================================
|icon| Sale Order Make Invoice Plus 12.0.1.0.0
==============================================


**Update default wizard handling invoice journal**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/sale_order_make_invoice_plus/static/description/icon.png
...
|en| Downpayment extended


|

|it| Fattura d'acconto estesa
...
* |menu| Setting > Apps |right_do| Select **sale_order_make_invoice_plus** > Install
...
12.0.1.0.0 (2021-04-26)
~~~~~~~~~~~~~~~~~~~~~~~
* [IMP] update default wizard handling invoice journal
