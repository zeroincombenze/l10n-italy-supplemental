...
class AccountConfigSettings(models.TransientModel):
    ...
    fatturapa_rea_office = fields.Many2one(
        related='company_id.rea_office', string="REA Office", readonly=False
    )
    fatturapa_rea_number = fields.Char(
        related='company_id.rea_code', string="REA Number", readonly=False
    )
    fatturapa_rea_capital = fields.Float(
        related='company_id.rea_capital', string="REA Capital", readonly=False
    )
    fatturapa_rea_partner = fields.Selection(
        related='company_id.rea_member_type', string="REA Copartner", readonly=False
    )
    ...
    def onchange_company_id(self):
        if self.company_id:
            ...
            self.fatturapa_rea_office = (
                company.rea_office and company.rea_office.id or False
            )
            self.fatturapa_rea_number = company.rea_code or False
            self.fatturapa_rea_capital = company.rea_capital or False
            self.fatturapa_rea_partner = company.rea_member_type or False
            self.fatturapa_rea_liquidation = company.rea_liquidation_state or False
