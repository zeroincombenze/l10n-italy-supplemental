...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
    'urn:uuid:f33a6cc4-abea-11ea-89e6-e09467884037'
)
...
CodiceType._InitializeFacetMap(CodiceType._CF_maxLength, CodiceType._CF_minLength)
...
FormatoTrasmissioneType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=FormatoTrasmissioneType
)
...
FormatoTrasmissioneType._InitializeFacetMap(
    FormatoTrasmissioneType._CF_enumeration, FormatoTrasmissioneType._CF_length
)
Namespace.addCategoryObject(
...
CausalePagamentoType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=CausalePagamentoType
)
...
CausalePagamentoType.M2 = CausalePagamentoType._CF_enumeration.addEnumeration(
    unicode_value='M2', tag='M2'
)
...
CausalePagamentoType.ZO = CausalePagamentoType._CF_enumeration.addEnumeration(
    unicode_value='ZO', tag='ZO'
)
...
TipoScontoMaggiorazioneType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=TipoScontoMaggiorazioneType
)
...
TipoScontoMaggiorazioneType._InitializeFacetMap(
    TipoScontoMaggiorazioneType._CF_enumeration, TipoScontoMaggiorazioneType._CF_length
)
Namespace.addCategoryObject(
...
Art73Type._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=Art73Type
)
...
Art73Type._InitializeFacetMap(Art73Type._CF_enumeration, Art73Type._CF_length)
...
TipoCassaType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=TipoCassaType
)
...
TipoCassaType._InitializeFacetMap(
    TipoCassaType._CF_enumeration, TipoCassaType._CF_length
)
...
TipoDocumentoType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=TipoDocumentoType
)
...
TipoDocumentoType.TD16 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD16', tag='TD16'
)
TipoDocumentoType.TD17 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD17', tag='TD17'
)
TipoDocumentoType.TD18 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD18', tag='TD18'
)
TipoDocumentoType.TD19 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD19', tag='TD19'
)
TipoDocumentoType.TD20 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD20', tag='TD20'
)
TipoDocumentoType.TD21 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD21', tag='TD21'
)
TipoDocumentoType.TD22 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD22', tag='TD22'
)
TipoDocumentoType.TD23 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD23', tag='TD23'
)
TipoDocumentoType.TD24 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD24', tag='TD24'
)
TipoDocumentoType.TD25 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD25', tag='TD25'
)
TipoDocumentoType.TD26 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD26', tag='TD26'
)
TipoDocumentoType.TD27 = TipoDocumentoType._CF_enumeration.addEnumeration(
    unicode_value='TD27', tag='TD27'
)
TipoDocumentoType._CF_length = pyxb.binding.facets.CF_length(
    value=pyxb.binding.datatypes.nonNegativeInteger(4)
)
TipoDocumentoType._InitializeFacetMap(
    TipoDocumentoType._CF_enumeration, TipoDocumentoType._CF_length
)
...
TipoRitenutaType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=TipoRitenutaType
)
...
TipoRitenutaType._InitializeFacetMap(
    TipoRitenutaType._CF_enumeration, TipoRitenutaType._CF_length
)
...
RiferimentoNumeroLineaType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(
    value=pyxb.binding.datatypes.integer(1), value_datatype=RiferimentoNumeroLineaType
)
...
SoggettoEmittenteType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=SoggettoEmittenteType
)
...
SoggettoEmittenteType._InitializeFacetMap(
    SoggettoEmittenteType._CF_enumeration, SoggettoEmittenteType._CF_length
)
Namespace.addCategoryObject(
...
RegimeFiscaleType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=RegimeFiscaleType
)
...
RegimeFiscaleType._InitializeFacetMap(
    RegimeFiscaleType._CF_enumeration, RegimeFiscaleType._CF_length
)
...
CondizioniPagamentoType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=CondizioniPagamentoType
)
...
ModalitaPagamentoType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=ModalitaPagamentoType
)
...
ModalitaPagamentoType._InitializeFacetMap(
    ModalitaPagamentoType._CF_enumeration, ModalitaPagamentoType._CF_length
)
Namespace.addCategoryObject(
...
RitenutaType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=RitenutaType
)
...
RitenutaType._InitializeFacetMap(RitenutaType._CF_enumeration, RitenutaType._CF_length)
...
EsigibilitaIVAType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=EsigibilitaIVAType
)
...
EsigibilitaIVAType._InitializeFacetMap(
...
NaturaType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=NaturaType
)
...
NaturaType.N2_1 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N2.1', tag='N2_1'
)
NaturaType.N2_2 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N2.2', tag='N2_2'
)
NaturaType.N3 = NaturaType._CF_enumeration.addEnumeration(unicode_value='N3', tag='N3')
NaturaType.N3_1 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N3.1', tag='N3_1'
)
NaturaType.N3_2 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N3.2', tag='N3_2'
)
NaturaType.N3_3 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N3.3', tag='N3_3'
)
NaturaType.N3_4 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N3.4', tag='N3_4'
)
NaturaType.N3_5 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N3.5', tag='N3_5'
)
NaturaType.N3_6 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N3.6', tag='N3_6'
)
...
NaturaType.N6_1 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N6.1', tag='N6_1'
)
NaturaType.N6_2 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N6.2', tag='N6_2'
)
NaturaType.N6_3 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N6.3', tag='N6_3'
)
NaturaType.N6_4 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N6.4', tag='N6_4'
)
NaturaType.N6_5 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N6.5', tag='N6_5'
)
NaturaType.N6_6 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N6.6', tag='N6_6'
)
NaturaType.N6_7 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N6.7', tag='N6_7'
)
NaturaType.N6_8 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N6.8', tag='N6_8'
)
NaturaType.N6_9 = NaturaType._CF_enumeration.addEnumeration(
    unicode_value='N6.9', tag='N6_9'
)
...
CodEORIType._InitializeFacetMap(CodEORIType._CF_maxLength, CodEORIType._CF_minLength)
...
SocioUnicoType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=SocioUnicoType
)
...
StatoLiquidazioneType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=StatoLiquidazioneType
)
...
TipoCessionePrestazioneType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=TipoCessionePrestazioneType
)
...
TipoCessionePrestazioneType._InitializeFacetMap(
    TipoCessionePrestazioneType._CF_enumeration, TipoCessionePrestazioneType._CF_length
)
Namespace.addCategoryObject(
...
TitoloType._InitializeFacetMap(TitoloType._CF_whiteSpace, TitoloType._CF_pattern)
...
String35LatinExtType._CF_maxLength = pyxb.binding.facets.CF_maxLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(35)
)
String35LatinExtType._CF_minLength = pyxb.binding.facets.CF_minLength(
    value=pyxb.binding.datatypes.nonNegativeInteger(1)
)
String35LatinExtType._InitializeFacetMap(
    String35LatinExtType._CF_maxLength, String35LatinExtType._CF_minLength
)
...
BolloVirtualeType._CF_enumeration = pyxb.binding.facets.CF_enumeration(
    enum_prefix=None, value_datatype=BolloVirtualeType
)
...
EmailType._CF_pattern.addPattern(
    pattern='([!#-\'*+/-9=?A-Z^-~-]+(\\.[!#-\'*+/-9=?A-Z^-~-]+)*|"(\\[\\]!#-[^-~ \\t]|(\\\\[\\t -~]))+")@([!#-\'*+/-9=?A-Z^-~-]+(\\.[!#-\'*+/-9=?A-Z^-~-]+)*|\\[[\\t -Z^-~]*\\])'
)
EmailType._InitializeFacetMap(EmailType._CF_maxLength, EmailType._CF_pattern)
...
RateType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(
    value=pyxb.binding.datatypes.decimal('100.0'), value_datatype=RateType
)
RateType._CF_pattern = pyxb.binding.facets.CF_pattern()
RateType._CF_pattern.addPattern(pattern='[0-9]{1,3}\\.[0-9]{2}')
RateType._InitializeFacetMap(RateType._CF_maxInclusive, RateType._CF_pattern)
...
RiferimentoFaseType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(
    value=pyxb.binding.datatypes.integer(999), value_datatype=RiferimentoFaseType
)
RiferimentoFaseType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(
    value=pyxb.binding.datatypes.integer(1), value_datatype=RiferimentoFaseType
)
RiferimentoFaseType._InitializeFacetMap(
    RiferimentoFaseType._CF_maxInclusive, RiferimentoFaseType._CF_minInclusive
)
...
NumeroColliType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(
    value=pyxb.binding.datatypes.integer(9999), value_datatype=NumeroColliType
)
NumeroColliType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(
    value=pyxb.binding.datatypes.integer(1), value_datatype=NumeroColliType
)
NumeroColliType._InitializeFacetMap(
    NumeroColliType._CF_maxInclusive, NumeroColliType._CF_minInclusive
)
...
NumeroLineaType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(
    value=pyxb.binding.datatypes.integer(9999), value_datatype=NumeroLineaType
)
NumeroLineaType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(
    value=pyxb.binding.datatypes.integer(1), value_datatype=NumeroLineaType
)
NumeroLineaType._InitializeFacetMap(
    NumeroLineaType._CF_maxInclusive, NumeroLineaType._CF_minInclusive
)
...
GiorniTerminePagamentoType._CF_maxInclusive = pyxb.binding.facets.CF_maxInclusive(
    value=pyxb.binding.datatypes.integer(999), value_datatype=GiorniTerminePagamentoType
)
GiorniTerminePagamentoType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(
    value=pyxb.binding.datatypes.integer(0), value_datatype=GiorniTerminePagamentoType
)
...
DataFatturaType._CF_minInclusive = pyxb.binding.facets.CF_minInclusive(
    value=pyxb.binding.datatypes.date('1970-01-01'), value_datatype=DataFatturaType
)
...
class FatturaElettronicaHeaderType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __DatiTrasmissione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiTrasmissione'),
        'DatiTrasmissione',
    ...
    __CedentePrestatore = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CedentePrestatore'),
        'CedentePrestatore',
    ...
    __RappresentanteFiscale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RappresentanteFiscale'),
    ...
    __CessionarioCommittente = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CessionarioCommittente'),
    ...
    __TerzoIntermediarioOSoggettoEmittente = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TerzoIntermediarioOSoggettoEmittente'),
    ...
    __SoggettoEmittente = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'SoggettoEmittente'),
        'SoggettoEmittente',
...
Namespace.addCategoryObject(
    'typeBinding', 'FatturaElettronicaHeaderType', FatturaElettronicaHeaderType
)
...
class FatturaElettronicaBodyType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __DatiGenerali = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiGenerali'),
        'DatiGenerali',
    ...
    __DatiBeniServizi = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiBeniServizi'),
        'DatiBeniServizi',
    ...
    __DatiVeicoli = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiVeicoli'),
        'DatiVeicoli',
    ...
    __DatiPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiPagamento'),
        'DatiPagamento',
    ...
    __Allegati = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Allegati'),
        'Allegati',
...
class DatiTrasmissioneType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __IdTrasmittente = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'IdTrasmittente'),
        'IdTrasmittente',
    ...
    __ProgressivoInvio = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ProgressivoInvio'),
        'ProgressivoInvio',
    ...
    __FormatoTrasmissione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'FormatoTrasmissione'),
        'FormatoTrasmissione',
    ...
    __CodiceDestinatario = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodiceDestinatario'),
        'CodiceDestinatario',
    ...
    __ContattiTrasmittente = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ContattiTrasmittente'),
    ...
    __PECDestinatario = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'PECDestinatario'),
        'PECDestinatario',
...
class IdFiscaleType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __IdPaese = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'IdPaese'),
        'IdPaese',
    ...
    __IdCodice = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'IdCodice'),
        'IdCodice',
    ...
    _ElementMap.update({__IdPaese.name(): __IdPaese, __IdCodice.name(): __IdCodice})
    _AttributeMap.update({})
...
class ContattiTrasmittenteType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Telefono = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Telefono'),
        'Telefono',
    ...
    __Email = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Email'),
        'Email',
    ...
    _ElementMap.update({__Telefono.name(): __Telefono, __Email.name(): __Email})
    _AttributeMap.update({})
...
class DatiGeneraliType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __DatiGeneraliDocumento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiGeneraliDocumento'),
    ...
    __DatiOrdineAcquisto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiOrdineAcquisto'),
        'DatiOrdineAcquisto',
    ...
    __DatiContratto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiContratto'),
        'DatiContratto',
    ...
    __DatiConvenzione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiConvenzione'),
        'DatiConvenzione',
    ...
    __DatiRicezione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiRicezione'),
        'DatiRicezione',
    ...
    __DatiFattureCollegate = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiFattureCollegate'),
    ...
    __DatiSAL = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiSAL'),
        'DatiSAL',
    ...
    __DatiDDT = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiDDT'),
        'DatiDDT',
    ...
    __DatiTrasporto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiTrasporto'),
        'DatiTrasporto',
    ...
    __FatturaPrincipale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'FatturaPrincipale'),
        'FatturaPrincipale',
...
class DatiGeneraliDocumentoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __TipoDocumento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TipoDocumento'),
        'TipoDocumento',
    ...
    __Divisa = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Divisa'),
        'Divisa',
    ...
    __Numero = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Numero'),
        'Numero',
    ...
    __DatiRitenuta = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiRitenuta'),
        'DatiRitenuta',
    ...
    __DatiBollo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiBollo'),
        'DatiBollo',
    ...
    __DatiCassaPrevidenziale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiCassaPrevidenziale'),
    ...
    __ScontoMaggiorazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ScontoMaggiorazione'),
        'ScontoMaggiorazione',
    ...
    __ImportoTotaleDocumento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ImportoTotaleDocumento'),
    ...
    __Arrotondamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Arrotondamento'),
        'Arrotondamento',
    ...
    __Causale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Causale'),
        'Causale',
    ...
    __Art73 = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Art73'),
        'Art73',
...
class DatiRitenutaType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __TipoRitenuta = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TipoRitenuta'),
        'TipoRitenuta',
    ...
    __ImportoRitenuta = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ImportoRitenuta'),
        'ImportoRitenuta',
    ...
    __AliquotaRitenuta = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'AliquotaRitenuta'),
        'AliquotaRitenuta',
    ...
    __CausalePagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CausalePagamento'),
        'CausalePagamento',
...
class DatiBolloType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __BolloVirtuale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'BolloVirtuale'),
        'BolloVirtuale',
    ...
    __ImportoBollo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ImportoBollo'),
        'ImportoBollo',
    ...
    _ElementMap.update(
        {__BolloVirtuale.name(): __BolloVirtuale, __ImportoBollo.name(): __ImportoBollo}
    )
    _AttributeMap.update({})
...
class DatiCassaPrevidenzialeType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __TipoCassa = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TipoCassa'),
        'TipoCassa',
    ...
    __AlCassa = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'AlCassa'),
        'AlCassa',
    ...
    __ImportoContributoCassa = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ImportoContributoCassa'),
    ...
    __ImponibileCassa = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ImponibileCassa'),
        'ImponibileCassa',
    ...
    __AliquotaIVA = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'AliquotaIVA'),
        'AliquotaIVA',
    ...
    __Ritenuta = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Ritenuta'),
        'Ritenuta',
    ...
    __Natura = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Natura'),
        'Natura',
    ...
    __RiferimentoAmministrazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoAmministrazione'),
...
class ScontoMaggiorazioneType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Tipo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Tipo'),
        'Tipo',
    ...
    __Percentuale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Percentuale'),
        'Percentuale',
    ...
    __Importo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Importo'),
        'Importo',
...
class DatiSALType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __RiferimentoFase = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoFase'),
        'RiferimentoFase',
    ...
    _ElementMap.update({__RiferimentoFase.name(): __RiferimentoFase})
    _AttributeMap.update({})
...
class DatiDocumentiCorrelatiType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __RiferimentoNumeroLinea = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoNumeroLinea'),
    ...
    __IdDocumento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'IdDocumento'),
        'IdDocumento',
    ...
    __NumItem = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumItem'),
        'NumItem',
    ...
    __CodiceCommessaConvenzione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodiceCommessaConvenzione'),
    ...
    __CodiceCUP = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodiceCUP'),
        'CodiceCUP',
    ...
    __CodiceCIG = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodiceCIG'),
        'CodiceCIG',
...
class DatiDDTType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __NumeroDDT = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroDDT'),
        'NumeroDDT',
    ...
    __DataDDT = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataDDT'),
        'DataDDT',
...
class DatiTrasportoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __DatiAnagraficiVettore = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiAnagraficiVettore'),
    ...
    __MezzoTrasporto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'MezzoTrasporto'),
        'MezzoTrasporto',
    ...
    __CausaleTrasporto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CausaleTrasporto'),
        'CausaleTrasporto',
    ...
    __NumeroColli = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroColli'),
        'NumeroColli',
    ...
    __Descrizione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Descrizione'),
        'Descrizione',
    ...
    __UnitaMisuraPeso = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'UnitaMisuraPeso'),
        'UnitaMisuraPeso',
    ...
    __PesoLordo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'PesoLordo'),
        'PesoLordo',
    ...
    __PesoNetto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'PesoNetto'),
        'PesoNetto',
    ...
    __DataOraRitiro = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataOraRitiro'),
        'DataOraRitiro',
    ...
    __DataInizioTrasporto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataInizioTrasporto'),
        'DataInizioTrasporto',
    ...
    __TipoResa = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TipoResa'),
        'TipoResa',
    ...
    __IndirizzoResa = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'IndirizzoResa'),
        'IndirizzoResa',
    ...
    __DataOraConsegna = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataOraConsegna'),
        'DataOraConsegna',
...
class IndirizzoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Indirizzo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Indirizzo'),
        'Indirizzo',
    ...
    __NumeroCivico = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroCivico'),
        'NumeroCivico',
    ...
    __CAP = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CAP'),
        'CAP',
    ...
    __Comune = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Comune'),
        'Comune',
    ...
    __Provincia = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Provincia'),
        'Provincia',
    ...
    __Nazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Nazione'),
        'Nazione',
...
class FatturaPrincipaleType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __NumeroFatturaPrincipale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroFatturaPrincipale'),
    ...
    __DataFatturaPrincipale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataFatturaPrincipale'),
...
class CedentePrestatoreType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Sede = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Sede'),
        'Sede',
    ...
    __StabileOrganizzazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'StabileOrganizzazione'),
    ...
    __IscrizioneREA = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'IscrizioneREA'),
        'IscrizioneREA',
    ...
    __Contatti = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Contatti'),
        'Contatti',
...
class DatiAnagraficiCedenteType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __IdFiscaleIVA = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'IdFiscaleIVA'),
        'IdFiscaleIVA',
    ...
    __CodiceFiscale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodiceFiscale'),
        'CodiceFiscale',
    ...
    __Anagrafica = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Anagrafica'),
        'Anagrafica',
    ...
    __AlboProfessionale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'AlboProfessionale'),
        'AlboProfessionale',
    ...
    __ProvinciaAlbo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ProvinciaAlbo'),
        'ProvinciaAlbo',
    ...
    __NumeroIscrizioneAlbo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroIscrizioneAlbo'),
    ...
    __DataIscrizioneAlbo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataIscrizioneAlbo'),
        'DataIscrizioneAlbo',
    ...
    __RegimeFiscale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RegimeFiscale'),
        'RegimeFiscale',
...
class AnagraficaType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Denominazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Denominazione'),
        'Denominazione',
    ...
    __Nome = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Nome'),
        'Nome',
    ...
    __Cognome = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Cognome'),
        'Cognome',
    ...
    __Titolo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Titolo'),
        'Titolo',
    ...
    __CodEORI = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodEORI'),
        'CodEORI',
...
class DatiAnagraficiVettoreType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __NumeroLicenzaGuida = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroLicenzaGuida'),
        'NumeroLicenzaGuida',
...
class IscrizioneREAType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Ufficio = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Ufficio'),
        'Ufficio',
    ...
    __NumeroREA = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroREA'),
        'NumeroREA',
    ...
    __CapitaleSociale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CapitaleSociale'),
        'CapitaleSociale',
    ...
    __SocioUnico = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'SocioUnico'),
        'SocioUnico',
    ...
    __StatoLiquidazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'StatoLiquidazione'),
        'StatoLiquidazione',
...
class ContattiType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Fax = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Fax'),
        'Fax',
    ...
    _ElementMap.update(
        {__Telefono.name(): __Telefono, __Fax.name(): __Fax, __Email.name(): __Email}
    )
    _AttributeMap.update({})
...
class RappresentanteFiscaleType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({__DatiAnagrafici.name(): __DatiAnagrafici})
    _AttributeMap.update({})
...
Namespace.addCategoryObject(
    'typeBinding', 'DatiAnagraficiRappresentanteType', DatiAnagraficiRappresentanteType
)
...
_module_typeBindings.RappresentanteFiscaleCessionarioType = (
...
Namespace.addCategoryObject(
    'typeBinding', 'DatiAnagraficiCessionarioType', DatiAnagraficiCessionarioType
)
...
class DatiBeniServiziType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __DettaglioLinee = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DettaglioLinee'),
        'DettaglioLinee',
    ...
    __DatiRiepilogo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DatiRiepilogo'),
        'DatiRiepilogo',
...
class DatiVeicoliType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __TotalePercorso = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TotalePercorso'),
        'TotalePercorso',
    ...
    _ElementMap.update(
        {__Data.name(): __Data, __TotalePercorso.name(): __TotalePercorso}
    )
    _AttributeMap.update({})
...
class DatiPagamentoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __CondizioniPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CondizioniPagamento'),
        'CondizioniPagamento',
    ...
    __DettaglioPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DettaglioPagamento'),
        'DettaglioPagamento',
...
class DettaglioPagamentoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Beneficiario = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Beneficiario'),
        'Beneficiario',
    ...
    __ModalitaPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ModalitaPagamento'),
        'ModalitaPagamento',
    ...
    __DataRiferimentoTerminiPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataRiferimentoTerminiPagamento'),
    ...
    __GiorniTerminiPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'GiorniTerminiPagamento'),
    ...
    __DataScadenzaPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataScadenzaPagamento'),
    ...
    __ImportoPagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ImportoPagamento'),
        'ImportoPagamento',
    ...
    __CodUfficioPostale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodUfficioPostale'),
        'CodUfficioPostale',
    ...
    __CognomeQuietanzante = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CognomeQuietanzante'),
        'CognomeQuietanzante',
    ...
    __NomeQuietanzante = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NomeQuietanzante'),
        'NomeQuietanzante',
    ...
    __CFQuietanzante = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CFQuietanzante'),
        'CFQuietanzante',
    ...
    __TitoloQuietanzante = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TitoloQuietanzante'),
        'TitoloQuietanzante',
    ...
    __IstitutoFinanziario = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'IstitutoFinanziario'),
        'IstitutoFinanziario',
    ...
    __IBAN = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'IBAN'),
        'IBAN',
    ...
    __ABI = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ABI'),
        'ABI',
    ...
    __CAB = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CAB'),
        'CAB',
    ...
    __BIC = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'BIC'),
        'BIC',
    ...
    __ScontoPagamentoAnticipato = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ScontoPagamentoAnticipato'),
    ...
    __DataLimitePagamentoAnticipato = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataLimitePagamentoAnticipato'),
    ...
    __PenalitaPagamentiRitardati = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'PenalitaPagamentiRitardati'),
    ...
    __DataDecorrenzaPenale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataDecorrenzaPenale'),
    ...
    __CodicePagamento = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodicePagamento'),
        'CodicePagamento',
...
_module_typeBindings.TerzoIntermediarioSoggettoEmittenteType = (
...
_module_typeBindings.DatiAnagraficiTerzoIntermediarioType = (
...
class AllegatiType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __NomeAttachment = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NomeAttachment'),
        'NomeAttachment',
    ...
    __AlgoritmoCompressione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'AlgoritmoCompressione'),
    ...
    __FormatoAttachment = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'FormatoAttachment'),
        'FormatoAttachment',
    ...
    __DescrizioneAttachment = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DescrizioneAttachment'),
    ...
    __Attachment = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Attachment'),
        'Attachment',
...
class DettaglioLineeType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __NumeroLinea = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'NumeroLinea'),
        'NumeroLinea',
    ...
    __TipoCessionePrestazione = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TipoCessionePrestazione'),
    ...
    __CodiceArticolo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodiceArticolo'),
        'CodiceArticolo',
    ...
    __Quantita = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Quantita'),
        'Quantita',
    ...
    __UnitaMisura = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'UnitaMisura'),
        'UnitaMisura',
    ...
    __DataInizioPeriodo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataInizioPeriodo'),
        'DataInizioPeriodo',
    ...
    __DataFinePeriodo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'DataFinePeriodo'),
        'DataFinePeriodo',
    ...
    __PrezzoUnitario = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'PrezzoUnitario'),
        'PrezzoUnitario',
    ...
    __PrezzoTotale = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'PrezzoTotale'),
        'PrezzoTotale',
    ...
    __AltriDatiGestionali = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'AltriDatiGestionali'),
        'AltriDatiGestionali',
...
class CodiceArticoloType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __CodiceTipo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodiceTipo'),
        'CodiceTipo',
    ...
    __CodiceValore = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'CodiceValore'),
        'CodiceValore',
    ...
    _ElementMap.update(
        {__CodiceTipo.name(): __CodiceTipo, __CodiceValore.name(): __CodiceValore}
    )
    _AttributeMap.update({})
...
class AltriDatiGestionaliType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __TipoDato = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'TipoDato'),
        'TipoDato',
    ...
    __RiferimentoTesto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoTesto'),
        'RiferimentoTesto',
    ...
    __RiferimentoNumero = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoNumero'),
        'RiferimentoNumero',
    ...
    __RiferimentoData = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoData'),
        'RiferimentoData',
...
class DatiRiepilogoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __SpeseAccessorie = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'SpeseAccessorie'),
        'SpeseAccessorie',
    ...
    __ImponibileImporto = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'ImponibileImporto'),
        'ImponibileImporto',
    ...
    __Imposta = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'Imposta'),
        'Imposta',
    ...
    __EsigibilitaIVA = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'EsigibilitaIVA'),
        'EsigibilitaIVA',
    ...
    __RiferimentoNormativo = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'RiferimentoNormativo'),
...
class FatturaElettronicaType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __FatturaElettronicaHeader = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'FatturaElettronicaHeader'),
    ...
    __FatturaElettronicaBody = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, 'FatturaElettronicaBody'),
    ...
    __Signature = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(_Namespace_ds, 'Signature'),
        'Signature',
    ...
    __SistemaEmittente = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, 'SistemaEmittente'),
        'SistemaEmittente',
        '__httpivaservizi_agenziaentrate_gov_itdocsxsdfatturev1_2_FatturaElettronicaType_SistemaEmittente',
        _module_typeBindings.String10Type,
    )
    __SistemaEmittente._DeclarationLocation = pyxb.utils.utility.Location(
        'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
        23,
        4,
    )
    __SistemaEmittente._UseLocation = pyxb.utils.utility.Location(
        'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
        23,
        4,
    )

    SistemaEmittente = property(
        __SistemaEmittente.value, __SistemaEmittente.set, None, None
    )
    ...
    _AttributeMap.update(
        {__versione.name(): __versione, __SistemaEmittente.name(): __SistemaEmittente}
    )
...
FatturaElettronica = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, 'FatturaElettronica'),
    FatturaElettronicaType,
    documentation='XML schema fatture destinate a PA e privati in forma ordinaria 1.2.1',
...
def _BuildAutomaton_2():
    ...
    st_4._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_5, [fac.UpdateInstruction(cc_1, True)]))
    st_5._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
...
def _BuildAutomaton_3():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IdFiscaleType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdPaese')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            64,
            6,
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        IdFiscaleType._UseForTag(pyxb.namespace.ExpandedName(None, 'IdCodice')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            65,
            6,
...
def _BuildAutomaton_4():
    ...
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        ContattiTrasmittenteType._UseForTag(pyxb.namespace.ExpandedName(None, 'Email')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            92,
            6,
...
def _BuildAutomaton_5():
    ...
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiContratto')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            104,
            6,
    ...
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiRicezione')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            106,
            6,
    ...
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiSAL')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            108,
            6,
    ...
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiDDT')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            109,
            6,
    ...
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliType._UseForTag(pyxb.namespace.ExpandedName(None, 'DatiTrasporto')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            110,
            6,
...
def _BuildAutomaton_6():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiGeneraliDocumentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Data')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            118,
            6,
    ...
    st_7._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_8, [fac.UpdateInstruction(cc_4, True)]))
    transitions.append(fac.Transition(st_9, [fac.UpdateInstruction(cc_4, False)]))
    ...
    st_8._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_9, [fac.UpdateInstruction(cc_5, True)]))
    ...
    st_9._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_10, [fac.UpdateInstruction(cc_6, True)]))
    transitions.append(fac.Transition(st_11, [fac.UpdateInstruction(cc_6, False)]))
    st_10._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_11, [fac.UpdateInstruction(cc_7, True)]))
...
def _BuildAutomaton_7():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiRitenutaType._UseForTag(pyxb.namespace.ExpandedName(None, 'TipoRitenuta')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            132,
            6,
...
def _BuildAutomaton_8():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiBolloType._UseForTag(pyxb.namespace.ExpandedName(None, 'BolloVirtuale')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            140,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiBolloType._UseForTag(pyxb.namespace.ExpandedName(None, 'ImportoBollo')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            141,
            6,
...
def _BuildAutomaton_10():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        ScontoMaggiorazioneType._UseForTag(pyxb.namespace.ExpandedName(None, 'Tipo')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            158,
            6,
...
def _BuildAutomaton_11():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiSALType._UseForTag(pyxb.namespace.ExpandedName(None, 'RiferimentoFase')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            468,
            6,
...
def _BuildAutomaton_13():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiDDTType._UseForTag(pyxb.namespace.ExpandedName(None, 'NumeroDDT')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            490,
            6,
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiDDTType._UseForTag(pyxb.namespace.ExpandedName(None, 'DataDDT')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            491,
            6,
...
def _BuildAutomaton_14():
    ...
    final_update.add(fac.UpdateInstruction(cc_3, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'NumeroColli')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            500,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_4, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Descrizione')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            501,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_6, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'PesoLordo')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            503,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'PesoNetto')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            504,
            6,
    ...
    symbol = pyxb.binding.content.ElementUse(
        DatiTrasportoType._UseForTag(pyxb.namespace.ExpandedName(None, 'TipoResa')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            507,
            6,
...
def _BuildAutomaton_15():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Indirizzo')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            514,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'NumeroCivico')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            515,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'CAP')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            516,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Comune')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            517,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Provincia')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            518,
            6,
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        IndirizzoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Nazione')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            519,
            6,
...
def _BuildAutomaton_17():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        CedentePrestatoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'Sede')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            549,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        CedentePrestatoreType._UseForTag(pyxb.namespace.ExpandedName(None, 'Contatti')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            552,
            6,
...
def _BuildAutomaton_19():
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        AnagraficaType._UseForTag(pyxb.namespace.ExpandedName(None, 'Denominazione')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            670,
            10,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        AnagraficaType._UseForTag(pyxb.namespace.ExpandedName(None, 'Nome')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            673,
            10,
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        AnagraficaType._UseForTag(pyxb.namespace.ExpandedName(None, 'Cognome')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            674,
            10,
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        AnagraficaType._UseForTag(pyxb.namespace.ExpandedName(None, 'Titolo')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            677,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        AnagraficaType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodEORI')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            678,
            6,
...
def _BuildAutomaton_21():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IscrizioneREAType._UseForTag(pyxb.namespace.ExpandedName(None, 'Ufficio')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            691,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IscrizioneREAType._UseForTag(pyxb.namespace.ExpandedName(None, 'NumeroREA')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            692,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        IscrizioneREAType._UseForTag(pyxb.namespace.ExpandedName(None, 'SocioUnico')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            694,
            6,
...
def _BuildAutomaton_22():
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        ContattiType._UseForTag(pyxb.namespace.ExpandedName(None, 'Telefono')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            700,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_1, False))
    symbol = pyxb.binding.content.ElementUse(
        ContattiType._UseForTag(pyxb.namespace.ExpandedName(None, 'Fax')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            701,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_2, False))
    symbol = pyxb.binding.content.ElementUse(
        ContattiType._UseForTag(pyxb.namespace.ExpandedName(None, 'Email')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            702,
            6,
...
def _BuildAutomaton_29():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiVeicoliType._UseForTag(pyxb.namespace.ExpandedName(None, 'Data')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            767,
            6,
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiVeicoliType._UseForTag(pyxb.namespace.ExpandedName(None, 'TotalePercorso')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            768,
            6,
...
def _BuildAutomaton_31():
    ...
    final_update.add(fac.UpdateInstruction(cc_10, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'IBAN')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            815,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_11, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'ABI')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            816,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_12, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'CAB')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            817,
            6,
    ...
    symbol = pyxb.binding.content.ElementUse(
        DettaglioPagamentoType._UseForTag(pyxb.namespace.ExpandedName(None, 'BIC')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            818,
            6,
...
def _BuildAutomaton_34():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        AllegatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'NomeAttachment')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            976,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        AllegatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'FormatoAttachment')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            978,
            6,
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        AllegatiType._UseForTag(pyxb.namespace.ExpandedName(None, 'Attachment')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            980,
            6,
...
def _BuildAutomaton_35():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'NumeroLinea')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            985,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'Descrizione')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            988,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'Quantita')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            989,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'UnitaMisura')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            990,
            6,
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'AliquotaIVA')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            996,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_7, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'Ritenuta')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            997,
            6,
    ...
    final_update.add(fac.UpdateInstruction(cc_8, False))
    symbol = pyxb.binding.content.ElementUse(
        DettaglioLineeType._UseForTag(pyxb.namespace.ExpandedName(None, 'Natura')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            998,
            6,
    ...
    st_8._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_9, [fac.UpdateInstruction(cc_6, True)]))
    transitions.append(fac.Transition(st_10, [fac.UpdateInstruction(cc_6, False)]))
    st_9._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_11, []))
    ...
    st_11._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_12, [fac.UpdateInstruction(cc_7, True)]))
    transitions.append(fac.Transition(st_13, [fac.UpdateInstruction(cc_7, False)]))
    transitions.append(fac.Transition(st_14, [fac.UpdateInstruction(cc_7, False)]))
    transitions.append(fac.Transition(st_15, [fac.UpdateInstruction(cc_7, False)]))
    st_12._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_13, [fac.UpdateInstruction(cc_8, True)]))
    transitions.append(fac.Transition(st_14, [fac.UpdateInstruction(cc_8, False)]))
    transitions.append(fac.Transition(st_15, [fac.UpdateInstruction(cc_8, False)]))
    st_13._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_14, [fac.UpdateInstruction(cc_9, True)]))
    transitions.append(fac.Transition(st_15, [fac.UpdateInstruction(cc_9, False)]))
    st_14._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_15, [fac.UpdateInstruction(cc_10, True)]))
    st_15._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
...
def _BuildAutomaton_36():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        CodiceArticoloType._UseForTag(pyxb.namespace.ExpandedName(None, 'CodiceTipo')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            1005,
            6,
...
def _BuildAutomaton_38():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiRiepilogoType._UseForTag(pyxb.namespace.ExpandedName(None, 'AliquotaIVA')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            1029,
            6,
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        DatiRiepilogoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Natura')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            1030,
            6,
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        DatiRiepilogoType._UseForTag(pyxb.namespace.ExpandedName(None, 'Imposta')),
        pyxb.utils.utility.Location(
            'https://www.fatturapa.gov.it/export/fatturazione/sdi/fatturapa/v1.3/Schema_del_file_xml_FatturaPA_versione_1.2.1.xsd',
            1034,
            6,
