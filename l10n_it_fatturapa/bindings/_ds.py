...
Namespace = pyxb.namespace.NamespaceForURI(
    'http://www.w3.org/2000/09/xmldsig#', create_if_missing=True
)
...
class SignedInfoType(pyxb.binding.basis.complexTypeDefinition):
    ...
    CanonicalizationMethod = property(
        __CanonicalizationMethod.value, __CanonicalizationMethod.set, None, None
    )
...
class CanonicalizationMethodType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Algorithm = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, 'Algorithm'),
        'Algorithm',
...
class SignatureMethodType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _HasWildcardElement = True
    _ElementMap.update({__HMACOutputLength.name(): __HMACOutputLength})
    _AttributeMap.update({__Algorithm.name(): __Algorithm})
...
class ReferenceType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __URI = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, 'URI'),
        'URI',
...
class TransformsType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({__Transform.name(): __Transform})
    _AttributeMap.update({})
...
class TransformType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _HasWildcardElement = True
    _ElementMap.update({__XPath.name(): __XPath})
    _AttributeMap.update({__Algorithm.name(): __Algorithm})
...
class RetrievalMethodType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({__Transforms.name(): __Transforms})
...
class SPKIDataType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _HasWildcardElement = True
    _ElementMap.update({__SPKISexp.name(): __SPKISexp})
    _AttributeMap.update({})
...
class ObjectType(pyxb.binding.basis.complexTypeDefinition):
    ...
    __Encoding = pyxb.binding.content.AttributeUse(
        pyxb.namespace.ExpandedName(None, 'Encoding'),
        'Encoding',
...
class ManifestType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({__Reference.name(): __Reference})
    _AttributeMap.update({__Id.name(): __Id})
...
class SignaturePropertiesType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({__SignatureProperty.name(): __SignatureProperty})
    _AttributeMap.update({__Id.name(): __Id})
...
class RSAKeyValueType(pyxb.binding.basis.complexTypeDefinition):
    ...
    _ElementMap.update({__Modulus.name(): __Modulus, __Exponent.name(): __Exponent})
    _AttributeMap.update({})
...
Namespace.addCategoryObject(
    'elementBinding', CanonicalizationMethod.name().localName(), CanonicalizationMethod
)
...
Namespace.addCategoryObject(
    'elementBinding', SignatureProperties.name().localName(), SignatureProperties
)
...
def _BuildAutomaton_14():
    ...
    st_0._set_transitionSet(transitions)
    transitions = []
    transitions.append(fac.Transition(st_0, [fac.UpdateInstruction(cc_0, False)]))
    transitions.append(fac.Transition(st_1, [fac.UpdateInstruction(cc_0, True)]))
    st_1._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
