...
===============================
|icon| Account Patch 12.0.0.0.1
===============================


**Patches to Odoo Invoicing (account) module**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_move_patch/static/description/icon.png
...
|en| Disable _validate_move_modification method
...
|it| Disabilita _validate_move_modification
...
* |menu| Setting > Apps |right_do| Select **account_move_patch** > Install
