...
===========================================================
|icon| ITA - Comunicazione liquidazione IVA plus 12.0.1.5.8
===========================================================


**Comunicazione liquidazione IVA ed esportazione file xmlconforme alle specifiche dell"Agenzia delle Entrate**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/l10n_it_vat_statement_communication_plus/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **l10n_it_vat_statement_communication_plus** > Install
