...
class WizardImportPartnerOpening(models.Model):
    _name = "wizard.import.partner.opening"
    ...
    def import_xls(self):
        ...
        return {
            ...
            'res_model': 'wizard.import.partner.opening',
            'view_type': 'form',
            'view_mode': 'form',
            'res_id': self.id,
            'target': 'new',
            'view_id': self.env.ref(
                'import_partner_opening.wizard_import_partner_opening_result'
            ).id,
            'domain': [('id', '=', self.id)],
        }
