...
class AccountInvoice(models.Model, BaseMixin):
    ...
    def write(self, vals):
        if "company_bank_id" in vals:
            ...
            lines.write({"company_bank_id": vals["company_bank_id"]})
        ...
        if "counterparty_bank_id" in vals:
            ...
            lines.write({"counterparty_bank_id": vals["counterparty_bank_id"]})
    ...
    def adapt_document(self):
        ...
        counterparty_bank_infos = self.partner_id and self.partner_id.bank_infos() or {}
