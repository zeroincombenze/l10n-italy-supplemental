...
========================================
|icon| Partner VAT capitalize 12.0.1.0.3
========================================


**Partner VAT capitalize first and second characters**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/res_partner_vat_plus/static/description/icon.png
...
|en| Italian VAT capitalize the first and the second characters

|

|it| Impostazione dei primi due caratteri della partita IVA in maiuscolo
...
* |menu| Setting > Apps |right_do| Select **res_partner_vat_plus** > Install
