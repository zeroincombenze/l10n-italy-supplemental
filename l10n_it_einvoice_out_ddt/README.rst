==============================================================
|icon| ITA - Fattura elettronica - Integrazione DDT 10.0.1.0.3
==============================================================

**Modulo ponte tra emissione fatture elettroniche e DDT**

.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy/10.0/l10n_it_einvoice_out_ddt/static/description/icon.png
...
|en| The module allows to choose if and how to fill XML fields related to DDTs,
in the two cases 'deferred invoice' and 'shipping invoice'.


|it| Questo modulo consente di scegliere se e come compilare i campi XML relativi ai DDT,
nei due casi "fattura differita" e "fattura accompagnatoria".


|thumbnail|

.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/l10n-italy/10.0/l10n_it_einvoice_out_ddt/static/description/description.png
