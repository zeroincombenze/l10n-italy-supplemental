...
=======================================================
|icon| Account Banking Sepa Direct Debit ITA 12.0.1.0.0
=======================================================


**Account Banking Sepa Direct Debit ITA for payment modules**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_banking_sepa_direct_debit_ita/static/description/icon.png
...
|en| Simplified features used by payment methods

|

|it| Funzionalità semplificate utilizzate dai metodi di pagamento
...
* |menu| Setting > Apps |right_do| Select **account_banking_sepa_direct_debit_ita** > Install
