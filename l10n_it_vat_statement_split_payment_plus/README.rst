...
=======================================================================
|icon| ITA - Liquidazione IVA + Scissione dei pagamenti plus 12.0.1.0.4
=======================================================================


**Migliora la liquidazione dell"IVA tenendo in considerazione la scissione dei pagamenti**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/l10n_it_vat_statement_split_payment_plus/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **l10n_it_vat_statement_split_payment_plus** > Install
