...
================================================================
|icon| Account Invoice Constraint Chronology No Draft 12.0.1.1.3
================================================================


**Validate using check on invoice not in state "draft"**

.. |icon| image:: https://raw.githubusercontent.com/PowERP-cloud/accounting/12.0/account_invoice_constraint_chronology_nodraft/static/description/icon.png
...
|en| Account Invoice Constraint Chronology No Draft


|

|it| Verifica sequenza date in fatture clienti e fornitori
...
* |menu| Setting > Apps |right_do| Select **account_invoice_constraint_chronology_nodraft** > Install
